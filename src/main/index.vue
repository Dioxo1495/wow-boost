...
<template>
  <main class="mt-3 grid gap-3">
    <h1 class="text-4xl">Welcome to Red Diamond Boost!</h1>
    ...
    <h2 class="text-2xl">Contac Us</h2>

    <span class="text-bold">Easy steps to contact us fast and easy</span>
    <div class="container">
